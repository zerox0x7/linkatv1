...
class SiteReviewController extends Controller
{
    ...
    public function index( Request $request )
    {
        ...
        // }
        $siteReviews = SiteReview::where('store_id',$store->id)->with('user')
            ->orderBy('created_at', 'desc')
            ->paginate(10);
            
        return view('themes.admin.site-reviews.index', compact('siteReviews'));
    }
    ...
    {
        return view('themes.admin.site-reviews.create');
    }
    ...
    public function show(SiteReview $siteReview)
    {
        ...
        return view('themes.admin.site-reviews.show', compact('siteReview'));
    }
    ...
    {
        return view('themes.admin.site-reviews.edit', compact('siteReview'));
    }
