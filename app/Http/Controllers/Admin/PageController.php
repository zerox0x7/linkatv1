...
class PageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('themes.admin.pages.index', compact('pages', 'footer_links_title', 'footer_policies_title'));
    }
    ...
    {
        return view('themes.admin.pages.show', compact('page'));
    }
    ...
    public function homeManager()
    {
        ...
        return view('themes.admin.pages.home-manager', compact('homeSections'));
    }
} 