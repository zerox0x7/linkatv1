...
class WhatsAppController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('themes.admin.whatsapp.index', compact('stats'));
    }
    ...
    public function settings()
    {
        $settings = [
            ...
            'admin_phones' => config('whatsapp.admin_phones'),
        ];
        
        return view('themes.admin.whatsapp.settings', compact('settings'));
    }
    ...
    public function updateSettings(Request $request)
    {
        $validated = $request->validate([
            ...
            'admin_phones' => 'required',
        ]);

        // تحديث ملف الإعدادات
        $this->updateConfigFile($validated);
        
        return redirect()->route('admin.whatsapp.settings')->with('success', 'تم تحديث الإعدادات بنجاح');
    }
    ...
    public function templates()
    {
        ...
        return view('themes.admin.whatsapp.templates.index', compact('templates'));
    }
    ...
    {
        return view('themes.admin.whatsapp.templates.create');
    }
    ...
    public function storeTemplate(Request $request)
    {
        $validated = $request->validate([
            ...
            'type' => 'required|string|in:order_pending,order_processing,order_completed,order_cancelled,order_refunded,otp,admin_notification',
    ...
    public function editTemplate($template)
    {
        ...
        return view('themes.admin.whatsapp.templates.edit', ['template' => $templateModel]);
    }
    ...
    public function testPage()
    {
        ...
        return view('themes.admin.whatsapp.test', compact('templates'));
    }
    ...
    public function logs()
    {
        ...
        return view('themes.admin.whatsapp.logs', compact('logs'));
    }
