...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('dashboard.custom_orders.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="dashboard_notes" id="dashboard_notes" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('dashboard_notes') }}</textarea>
                    ...
                    <div class="md:col-span-2 flex justify-end">
                        <a href="{{ route('dashboard.custom_orders.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ml-3">
                            إلغاء
                        </a>
