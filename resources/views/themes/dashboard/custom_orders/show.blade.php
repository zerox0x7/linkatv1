...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            <a href="{{ route('dashboard.custom_orders.index') }}" class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <a href="{{ route('dashboard.users.show', $customOrder->user->id) }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            عرض ملف العميل
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    <a href="{{ route('dashboard.custom_orders.edit', $customOrder) }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        <svg class="ml-2 -mr-0.5 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <form action="{{ route('dashboard.custom_orders.update_status', $customOrder) }}" method="POST">
                        @csrf
                        @method('PUT')
                    ...
                    <form id="delete-order" action="{{ route('dashboard.custom_orders.destroy', $customOrder) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
