...
<div class="card mb-4 bg-white dark:bg-gray-900 rounded-lg shadow">
    <div class="card-header d-flex justify-content-between align-items-center bg-gray-50 dark:bg-gray-800">
        ...
        <div>
            <a href="{{ route('dashboard.categories.edit', $category) }}" class="btn btn-primary btn-sm me-2 bg-blue-600 dark:bg-blue-700 text-white">
                <i class="fas fa-edit"></i> تعديل
            </a>
            <a href="{{ route('dashboard.categories.index') }}" class="btn btn-secondary btn-sm bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200">
                ...
                <tbody>
                    @foreach($category->children as $childCategory)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.categories.show', $childCategory) }}" class="btn btn-sm btn-info bg-blue-500 dark:bg-blue-700 text-white">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('dashboard.categories.edit', $childCategory) }}" class="btn btn-sm btn-warning bg-yellow-400 dark:bg-yellow-600 text-white">
                ...
                <tbody>
                    @foreach($category->products as $product)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.products.show', $product) }}" class="btn btn-sm btn-info bg-blue-500 dark:bg-blue-700 text-white">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('dashboard.products.edit', $product) }}" class="btn btn-sm btn-warning bg-yellow-400 dark:bg-yellow-600 text-white">
                                    <i class="fas fa-edit"></i>
                                </a>
                            </td>
                        </tr>
