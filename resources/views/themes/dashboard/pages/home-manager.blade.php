        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden flex flex-col h-full">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('dashboard.home-sections.index') }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-primary-600 hover:bg-primary-700 dark:bg-primary-700 dark:hover:bg-primary-800 text-white rounded shadow text-sm">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden flex flex-col h-full">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <a href="{{ route('dashboard.home-sliders.index') }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-info-600 hover:bg-info-700 dark:bg-info-700 dark:hover:bg-info-800 text-white rounded shadow text-sm mb-2">
                        <i class="fas fa-images ml-1"></i> إدارة السلايدر
                    </a>
                    <a href="{{ route('dashboard.home-sliders.create') }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white rounded shadow text-sm">
