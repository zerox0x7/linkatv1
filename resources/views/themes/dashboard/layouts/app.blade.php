    ...
    <div x-data="{ sidebarOpen: false  }">
        ...
        <div class="fixed inset-y-0 right-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 lg:translate-x-0" 
            ...
            <div class="py-4">
                <nav>
                    <a href="#" 
                       class="flex items-center px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.dashboard') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                        <svg class="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        <span>لوحةeeeee التحكم</span>
                    </a>
                    
                    <!-- قائمة المنتجات والتصنيفات -->
                    <div x-data="{ open: {{ request()->routeIs('dashboard.products.*') || request()->routeIs('dashboard.categories.*') ? 'true' : 'false' }} }" class="">
                        ...
                        <div x-show="open" class="pl-8" x-transition>
                            <a href="{{ route('dashboard.products.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.products.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                                <i class="ri-shopping-bag-3-line ml-2"></i>
                                <span class="ml-2">المنتجات</span>
                            </a>
                            <a href="{{ route('dashboard.categories.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.categories.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                                <i class="ri-price-tag-3-line ml-2"></i>
                                <span class="ml-2">التصنيفات</span>
                            </a>
                            <a href="{{ route('dashboard.coupons.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.coupons.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('dashboard.orders.*') || request()->routeIs('dashboard.reports.*') ? 'true' : 'false' }} }" class="">
                        <button @click="open = !open" type="button" class="flex items-center w-full px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 focus:outline-none" :class="{ 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white': open }">
                            <svg class="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="open" class="pl-8" x-transition>
                            <a href="{{ route('dashboard.orders.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.orders.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                                <i class="ri-file-list-3-line ml-2"></i>
                                <span class="ml-2">الطلبات</span>
                            </a>
                            <a href="{{ route('dashboard.reports.sales') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.reports.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                    ...
                    <a href="{{ route('dashboard.users.index') }}" 
                       class="flex items-center px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.users.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                        <svg class="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('dashboard.payment-methods.index') }}"
                       class="flex items-center px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.payment-methods.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                    ...
                    <a href="{{ route('dashboard.reviews.index') }}"
                       class="flex items-center px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.reviews.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                    ...
                    <!-- قائمة الإعدادات -->
                    <div x-data="{ open: {{ request()->routeIs('dashboard.home-sections.*') ? 'true' : 'false' }} }" class="">
                        <button @click="open = !open" type="button" class="flex items-center w-full px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 focus:outline-none" :class="{ 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white': open }">
                        ...
                        <div x-show="open" class="pl-8" x-transition>
                            <a href="{{ route('dashboard.home-sections.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.home-sections.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('dashboard.settings.*') || request()->routeIs('dashboard.pages.*') || request()->routeIs('dashboard.whatsapp.*') ? 'true' : 'false' }} }" class="">
                        <button @click="open = !open" type="button" class="flex items-center w-full px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 focus:outline-none" :class="{ 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white': open }">
                            <svg class="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="open" class="pl-8" x-transition>
                            <a href="{{ route('dashboard.settings.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.settings.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                                <i class="ri-settings-3-line ml-2"></i>
                                <span class="ml-2">الإعدادات العامة</span>
                            </a>
                        
                            <a href="{{ route('dashboard.pages.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.pages.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                                <i class="ri-pages-line ml-2"></i>
                                <span class="ml-2">الصفحات</span>
                            </a>
                            <a href="{{ route('dashboard.whatsapp.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.whatsapp.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
                                <i class="ri-whatsapp-line ml-2"></i>
                                <span class="ml-2">إدارة إشعارات واتساب</span>
                            </a>
                            <a href="{{ route('dashboard.online-users.index') }}" class="flex items-center px-4 py-2 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 {{ request()->routeIs('dashboard.online-users.*') ? 'bg-blue-500 text-white dark:bg-blue-600 dark:text-white' : '' }}">
