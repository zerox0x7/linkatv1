    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-2/5">
            <div class="glass-effect rounded-lg overflow-hidden">
                <div class="h-[400px] bg-center bg-cover" style="background-image: url('{{ $product->image_url }}')" aria-label="{{ $product->name }}" role="img" title="{{ $product->name }} - {{ $product->category ? $product->category->name : '' }}"></div>
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        <!-- Main Image -->
                        <div class="h-[400px] overflow-hidden rounded-lg mb-4">
                            <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="w-full h-full object-cover transition-transform duration-300 hover:scale-105">
                        </div>
                        
                        <!-- Gallery Thumbnails -->
                        <div class="flex justify-center gap-2 p-4">
                            @foreach($product->gallery as $key => $image)
                            <div class="relative w-24 h-24 rounded-lg overflow-hidden cursor-pointer border-2 border-gray-600 hover:border-primary transition-all">
                ...
                <!-- Image Lightbox -->
                <div id="image-lightbox" class="fixed inset-0 bg-black bg-opacity-90 hidden flex items-center justify-center z-50">
                    <div class="relative max-w-6xl max-h-[90vh]">
                        <img id="lightbox-image" src="" alt="" class="max-w-full max-h-[90vh] object-contain">
                        <button onclick="closeLightbox()" class="absolute top-4 left-4 text-white hover:text-gray-300">
