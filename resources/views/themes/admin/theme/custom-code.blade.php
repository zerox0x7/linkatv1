...
<head>
    ...
    <title>الأكواد المخصصة - {{ \App\Models\Setting::get('store_name', config('app.name')) }}</title>
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg bg-gradient-to-r from-purple-500/20 to-pink-500/20 flex items-center justify-center">
                                <i class="ri-code-line text-purple-400"></i>
                            </div>
                            الأكواد المخصصة للثيم
                        </h1>
                        <p class="text-gray-400 mt-1">إدارة CSS/JS المخصصة: <span class="text-primary font-semibold">{{ ucfirst($activeTheme) }}</span></p>
                    </div>
