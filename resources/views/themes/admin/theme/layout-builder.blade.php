...
<head>
    ...
    <title>منشئ التخطيط - {{ \App\Models\Setting::get('store_name', config('app.name')) }}</title>
...
<body class="bg-[#0a0f1a] text-gray-100" style="overflow-y: scroll; -ms-overflow-style: none; scrollbar-width: none;">
            ...
            <div class="bg-gradient-to-r from-[#0f1623] to-[#162033] border-b border-[#2a3548] sticky top-0 z-40 shadow-lg">
                <div class="flex items-center justify-between p-6">
                    <div>
                        ...
                        <p class="text-gray-400 mt-1">قم ببناء وترتيب أقسام تخطيط الثيم: <span class="text-primary font-semibold">{{ ucfirst($activeTheme) }}</span></p>
                    </div>
    ...
    <style>
        ...
        .custom-scrollbar::-webkit-scrollbar-track { background: rgba(42, 53, 72, 0.3); border-radius: 3px; }
        .custom-scrollbar::-webkit-scrollbar-thumb { background: linear-gradient(135deg, #15B8A6, #10b981); border-radius: 3px; }
