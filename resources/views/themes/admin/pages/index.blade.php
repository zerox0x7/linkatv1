...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-2 space-x-reverse">
            <a href="{{ route('admin.pages.home-manager') }}" class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white py-2 px-4 rounded shadow">
                <i class="fas fa-home ml-1"></i> إدارة الصفحة الرئيسية
            </a>
            <a href="{{ route('admin.pages.create') }}" class="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white py-2 px-4 rounded shadow">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2 space-x-reverse">
                    <a href="{{ route('admin.home-sections.index') }}" class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white py-2 px-4 rounded shadow">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden mb-6">
        <div class="px-6 py-4 flex items-center justify-between">
            ...
            <a href="{{ route('admin.marquee') }}" class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white py-2 px-4 rounded shadow flex items-center">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2 space-x-reverse">
                    <a href="{{ route('admin.home-sliders.index') }}" class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white py-2 px-4 rounded shadow">
                        <i class="fas fa-images ml-1"></i> إدارة السلايدر
                    </a>
                    <a href="{{ route('admin.home-sliders.create') }}" class="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white py-2 px-4 rounded shadow">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            ...
            <a href="{{ route('admin.pages.create') }}" class="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white py-2 px-4 rounded shadow text-sm flex items-center">
                <i class="fas fa-plus ml-1"></i> إضافة صفحة جديدة
            </a>
        </div>
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center space-x-3 space-x-reverse">
                                    ...
                                    <a href="{{ route('admin.pages.edit', $page) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                    </a>
                                    
                                    <form action="{{ route('admin.pages.destroy', $page) }}" method="POST" class="inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500 dark:text-gray-300">
                                لا توجد صفحات حتى الآن. <a href="{{ route('admin.pages.create') }}" class="text-blue-600 hover:underline dark:text-blue-400">إضافة صفحة جديدة</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('admin.menu-links.create', ['section' => 'quick_links']) }}" class="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white py-2 px-4 rounded shadow">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center space-x-3 space-x-reverse">
                                        ...
                                        <a href="{{ route('admin.menu-links.edit', $link) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </a>
                                        
                                        <form action="{{ route('admin.menu-links.destroy', $link) }}" method="POST" class="inline-block delete-form">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-200">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-500 dark:text-gray-300">
                                    لا توجد روابط سريعة حتى الآن. <a href="{{ route('admin.menu-links.create', ['section' => 'quick_links']) }}" class="text-blue-600 hover:underline dark:text-blue-400">إضافة رابط جديد</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('admin.menu-links.create', ['section' => 'policies']) }}" class="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white py-2 px-4 rounded shadow">
                    <i class="fas fa-plus ml-1"></i> إضافة رابط جديد
                </a>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-500 dark:text-gray-300">
                                    لا توجد روابط للسياسات حتى الآن. <a href="{{ route('admin.menu-links.create', ['section' => 'policies']) }}" class="text-blue-600 hover:underline dark:text-blue-400">إضافة رابط جديد</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden mt-8">
        ...
        <div class="p-6">
            <form action="{{ route('admin.settings.payment-icons.upload') }}" method="POST" enctype="multipart/form-data" class="mb-6">
                @csrf
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    @forelse($paymentIcons as $icon)
                        <div class="relative group border border-gray-200 dark:border-gray-700 rounded-lg p-2 bg-gray-50 dark:bg-gray-800 flex flex-col items-center justify-center">
                            ...
                            <form action="{{ route('admin.settings.payment-icons.delete') }}" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذه الأيقونة؟');">
                                @csrf
...
<script>
    ...
    function saveFooterTitle(key) {
        ...
        fetch("{{ route('admin.settings.updateFooterTitle') }}", {
            method: 'POST',
            headers: {
