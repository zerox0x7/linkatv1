...
<head>
    ...
    <title>إضافة صفحة ثابتة جديدة</title>
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-white mb-2">إضافة صفحة ثابتة جديدة</h1>
                            <p class="text-gray-400">أدخل معلومات الصفحة الجديدة</p>
                        </div>
                ...
                <!-- Form -->
                <form action="{{ route('admin.static-pages.store') }}" method="POST" class="space-y-6">
                    @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    rows="3"
                                    placeholder="وصف الصفحة في محركات البحث">{{ old('meta_description') }}</textarea>
                    ...
                    <!-- Action Buttons -->
                    <div class="flex items-center justify-end gap-4 bg-gradient-to-br from-[#0f1623] to-[#162033] rounded-lg p-6 border border-gray-700/50">
                        <a href="{{ route('admin.static-pages.index') }}" 
                            class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-medium rounded-button transition-colors">
                            إلغاء
                        </a>
                        <button type="submit" 
