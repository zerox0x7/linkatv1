    ...
    <div id="couponWizardOverlay" class="coupon-wizard-overlay">
        ...
        <div id="couponWizardTooltip" class="coupon-wizard-tooltip">
            <div class="coupon-wizard-header">
                ...
                <h3 class="coupon-wizard-title" id="wizardTitle">مرحباً بك في إعدادات الكوبون {{$coupon->code}}</h3>
            </div>
                    ...
                    @foreach($orders as $i => $order)
                        <tr class="text-center">
                            ...
                            <td class="px-4 py-2 border-b">
                                <a href="{{ route('admin.orders.show', $order->id) }}" class="text-blue-600 hover:underline">{{ $order->id }}</a>
                            </td>
                ...
                @foreach($orders as $i => $order)
                    <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-4 flex flex-col gap-2">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('admin.orders.show', $order->id) }}" class="text-blue-600 hover:underline font-bold">طلب رقم {{ $order->id }}</a>
                        </div>
