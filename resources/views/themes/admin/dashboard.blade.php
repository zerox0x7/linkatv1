...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.orders.index') }}" class="text-sm text-blue-500 hover:underline">عرض الكل</a>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                                <a href="{{ route('admin.orders.show', $order) }}" class="text-blue-500 hover:underline">#{{ $order->id }}</a>
                            </td>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.custom_orders.index') }}" class="text-sm text-blue-500 hover:underline">عرض الكل</a>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                            <a href="{{ route('admin.custom_orders.show', $order) }}" class="text-blue-500 hover:underline">#{{ $order->id }}</a>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                            {{ $order->user->name }}
                        </td>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                            <a href="{{ route('admin.custom_orders.show', $order) }}" class="text-blue-600 hover:text-blue-900 mx-1">عرض</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
