...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">تعديل التقييم</h1>
    ...
    <div class="bg-gray-50 p-4 rounded-md mb-6">
        <h2 class="text-lg font-medium text-gray-700 mb-2">معلومات التقييم</h2>
    ...
    <form action="{{ route('admin.reviews.update', $review) }}" method="POST">
        ...
        <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <div class="flex">
                        ...
                        <label class="p-1 cursor-pointer">
                            ...
                            <svg class="w-8 h-8 {{ old('rating', $review->rating) >= $i ? 'text-yellow-400' : 'text-gray-300' }} star-rating" data-rating="{{ $i }}" fill="currentColor" viewBox="0 0 20 20">
           ...
           <div>
    <label for="comment" class="block text-sm font-medium text-gray-700 mb-1">التعليق</label>
    ...
    @enderror
            ...
            <div class="flex items-center">
                ...
                <input type="checkbox" id="is_approved" name="is_approved" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded" {{ old('is_approved', $review->is_approved) ? 'checked' : '' }}>
